...
#ifndef IPROUTE2_CONFDIR
#define IPROUTE2_CONFDIR "/etc/iproute2"
#endif
...
static void rtnl_rtprot_initialize(void)
{
	...
	rtnl_tab_initialize(IPROUTE2_CONFDIR "/rt_protos", rtnl_rtprot_tab->tab);
}
...
static void rtnl_rtscope_initialize(void)
{
	...
	rtnl_tab_initialize(IPROUTE2_CONFDIR "/rt_scopes", rtnl_rtscope_tab->tab);
}
...
static void rtnl_rtrealm_initialize(void)
{
	...
	rtnl_tab_initialize(IPROUTE2_CONFDIR "/rt_realms", rtnl_rtrealm_tab->tab);
}
...
static void rtnl_rtdsfield_initialize(void)
{
	...
	rtnl_tab_initialize(IPROUTE2_CONFDIR "/rt_dsfield", rtnl_rtdsfield_tab->tab);
}
...
static void rtnl_rttable_initialize(void)
{
	...
	rtnl_tab_initialize(IPROUTE2_CONFDIR "/rt_tables", rtnl_rttable_tab->tab);
}
